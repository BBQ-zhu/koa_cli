        ...
        >
          <div class="">
            <el-form-item label="新闻标题:" prop="newsname">
              <el-input v-model="ruleForm.newsname" placeholder="请输入新闻标题" style="width:200%"></el-input>
            </el-form-item>
            <el-form-item label="新闻描述:" prop="message">
              <el-input v-model="ruleForm.message" placeholder="请输入新闻描述" style="width:200%"></el-input>
            </el-form-item>
            <el-form-item label="阅读量:" prop="num">
              <el-input v-model="ruleForm.num" placeholder="请输入阅读量" style="width:200%"></el-input>
            </el-form-item>
          </div>
        </el-form>
        <div class="title mt20 mb20">新闻详情</div>
        <UE :defaultMsg="ruleForm.content" :config="config" :id="ueId" ref="editor"></UE>
      </span>
      <div class="flex mt10 windBtn">
        <el-button @click="handleClose">取 消</el-button>
        <el-button v-if="meth[2] || meth[0]" type="primary" @click="uploadAdd">确 定</el-button>
      </div>
    </div>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        message: [{ required: true, message: '请输入新闻描述', trigger: 'blur' }],
  ...
  methods: {
    ...
    async uploadAdd() {
      ...
      if (this.isAdd) {
        ...
        this.ruleForm.creators = JSON.parse(sessionStorage.getItem('userInfo') || '{}').username
