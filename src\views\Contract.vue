          ...
          <div class="flex">
            ...
            >
              <el-input
                ...
                placeholder="抽成比例:例如3"
              ></el-input>
            </el-form-item>
            <el-form-item
              v-if="ruleForm.mode == '直接收费'"
              label="服务费用:"
              prop="service"
            >
              <el-input
            ...
            <el-form-item
              :label="ruleForm.loantype == '抵押贷款' ? '抵押物：' : '申请物：'"
              prop="collateral"
            >
              <el-input
                clearable
                v-model="ruleForm.collateral"
                placeholder="请输入抵押物、申请物"
              ></el-input>
            </el-form-item>
        ...
        <template slot-scope="scope">
          <el-tooltip placement="right">
            <div slot="content" style="width:220px;height:100px;background:#fff;">
              <img :src="scope.row.imgurl"  style="width:90px;height:200px;transform: rotate(-90deg);margin-left:65px;margin-top:-50px"/>
            </div>
            <span
              @click="
                conDownLoad(
    ...
    proContract() {
      ...
      this.$confirm("确认生成合同信息吗？", "提示", {
        ...
        .then(async () => {
          ...
          this.ruleForm.remarks = await contractTxt(
            this.ruleForm,
            this.vipUser
          );
