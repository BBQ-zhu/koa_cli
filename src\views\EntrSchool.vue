  ...
  <div class="card">
    <div class="flex header">
      <el-button
        ...
        >上传视频</el-button
      >
      <div class="el-upload__tip ml10" slot="tip" style="line-height: 33px">
        视频内容不易过大
      </div>
      <el-dialog
        title="上传视频"
      ...
      >
        <div class="mr10">
          ...
          >
            ...
            <i
              class="el-icon-video-play color3"
              style="
                position: absolute;
                top: 60px;
                left: 110px;
  ...
  methods: {
    ...
    delBtn(_id, videourl, videoImg) {
      this.$confirm("确认删除该视频？", "提示", {
        ...
        await this.$axios.post(this.$api.delateVideoImg, {
          videoImg: videoImg,
        });
      });
    },
