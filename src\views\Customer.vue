            ...
            <el-collapse-item title="基本情况" name="1">
              <div class="flex">
                ...
                <el-form-item label="资金用途:" prop="utility">
                  <el-input
                    v-model="ruleForm.utility"
                    placeholder="请输入资金用途"
                  ></el-input>
                </el-form-item>
                <el-form-item label="贷款期限:" prop="tenor">
                  <el-input
                    v-model="ruleForm.tenor"
                    placeholder="请输入贷款期限"
                  ></el-input>
                </el-form-item>
            ...
            <el-collapse-item title="收入情况" name="2">
              <div class="flex">
                ...
                <el-form-item label="工作岗位:" prop="unitposition">
                  <el-input
                    v-model="ruleForm.unitposition"
                    placeholder="请输入工作岗位"
                  ></el-input>
                </el-form-item>
                <el-form-item label="单位地址:" prop="unitadress">
                  <el-input
                    v-model="ruleForm.unitadress"
                    placeholder="请输入单位地址"
                  ></el-input>
                </el-form-item>
            ...
            <el-collapse-item title="房屋情况" name="3">
              <div class="flex">
                ...
                <el-form-item label="小区名称:" prop="housesname">
                  <el-input
                    v-model="ruleForm.housesname"
                    placeholder="请输入小区名称"
                  ></el-input>
                </el-form-item>
                <el-form-item label="小区地址:" prop="houaddress">
                  <el-input
                    v-model="ruleForm.houaddress"
                    placeholder="请输入小区地址"
                  ></el-input>
                </el-form-item>
                ...
                <el-form-item label="贷款金额:" prop="houamount">
                  <el-input
                    v-model="ruleForm.houamount"
                    placeholder="抵押请输入贷款金额"
                  ></el-input>
                </el-form-item>
              </div>
            </el-collapse-item>
            <el-collapse-item title="车辆情况" name="4">
              <div class="flex">
                ...
                <el-form-item label="剩余待还:" prop="carema">
                  <el-input
                    v-model="ruleForm.carema"
                    placeholder="按揭请填写待还金额"
                  ></el-input>
                </el-form-item>
              </div>
            </el-collapse-item>
            ...
            <el-collapse-item title="紧急情况" name="7">
              <div class="flex">
                ...
                <el-form-item label="联系人电话:" prop="conphone1">
                  <el-input
                    v-model="ruleForm.conphone1"
                    placeholder="请输入第一联系人电话"
                  ></el-input>
                </el-form-item>
                ...
                <el-form-item label="联系人电话:" prop="conphone3">
                  <el-input
                    v-model="ruleForm.conphone3"
                    placeholder="请输入第三联系人电话"
                  ></el-input>
                </el-form-item>
