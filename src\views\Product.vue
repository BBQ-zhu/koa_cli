            ...
            <el-form-item label="产品图片:" prop="productimg">
              <div style="position: relative">
                ...
                >
                  ...
                  <el-button type="primary" v-if="meth[0] || meth[2]">点击上传</el-button>
                </el-upload>
              </div>
            </el-form-item>
          </div>
      ...
      <span>
        ...
        >
          ...
          <el-form-item label="展示顺序:" prop="number">
            <el-input v-model="iconForm.number" placeholder="展示顺序:数值越小越靠前" class="new-input"></el-input>
          </el-form-item>
        ...
        <div class="flex">
          ...
          >
            ...
            ></i>
            <img :src="item.imgurl" style="width: 100px; height: 100px; margin: 0 auto" />
...
export default {
  ...
  methods: {
    ...
    async logoSuccess(res, file, fileList) {
      if (res.code == 200) {
        if(!this.isAdd){
          await this.$axios.post(this.$api.updataProduct, {_id:this.ruleForm._id,productlogo: res.data})
        }
    ...
    async handSuccess(res, file, fileList) {
      ...
      if (res.code == 200) {
        if(!this.isAdd){
          await this.$axios.post(this.$api.updataProduct, {_id:this.ruleForm._id,productimg: res.data})
        }
